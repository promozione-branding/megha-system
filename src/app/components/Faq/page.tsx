...
export default function WashroomCubiclesFAQ() {
  ...
  return (
    <section className="pt-2 sm:pt-4 lg:pt-6 pb-16 md:pb-20 lg:pb-15 bg-white flex items-center justify-center px-4 sm:px-8 lg:px-16 font-sans text-slate-900 antialiased">
