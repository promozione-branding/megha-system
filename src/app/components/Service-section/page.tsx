            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className={`group relative rounded-[32px] p-6 sm:p-6 flex flex-col justify-between min-h-[380px] sm:min-h-[420px] transition-all duration-500 overflow-hidden cursor-pointer ${
                    service.isImageCard
