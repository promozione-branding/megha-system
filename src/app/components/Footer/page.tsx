          ...
          <div className="md:col-span-6 lg:col-span-5 grid grid-cols-2 gap-8 sm:gap-12 pt-2">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3 pt-2">
                ...
                {/* <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 border border-white/20 text-white flex items-center justify-center hover:bg-white hover:text-[#0b1329] transition-all shadow-sm" aria-label="LinkedIn" > <FaLinkedinIn className="w-4 h-4" /> </a> */}
