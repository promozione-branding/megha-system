          ...
          >
            <div className="max-w-3xl">
              ...
              <h1 className="text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl lg:text-[64px]">
                Spaces{" "}
                <span className="font-medium text-[#0d2461]/35">We've</span>{" "}
                <br className="hidden sm:block" />
                Beautifully{" "}
                <span className="font-medium text-[#0d2461]/35">Realized.</span>
              </h1>
            </div>
            ...
            >
              Explore some of the commercial spaces where our craftsmanship,
              precision, and attention to detail come together.
            </motion.p>
          </motion.div>
