                ...
                <div className="relative z-10 mx-auto max-w-[1536px] px-5 py-10 sm:px-8 sm:py-12 lg:px-12 lg:py-14 xl:px-16">
                    ...
                    >
                        ...
                        <p className="mt-2 max-w-2xl text-sm leading-7 text-white/55 sm:text-base sm:leading-8">
                            Looking for reliable toilet cubicles, washroom partitions, or
                            HPL solutions? Tell us about your requirements and our team will
                        ...
                        >
                            ...
                            <div className="mt-5 space-y-3">
                                ...
                                <a
                                    ...
                                    className="group flex items-center gap-4 rounded-2xl border border-gray-200 bg-white p-4 transition-all duration-300 hover:-translate-y-0.5 hover:border-[#0d2461]/20 hover:shadow-lg"
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-1 text-sm font-semibold text-[#0d2461]">
                                            contact@meghasystems.com
                                        </p>

                                        <p className="text-sm font-semibold text-[#0d2461]">
                                ...
                                <form className="mt-7 space-y-5">
                                    ...
                                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="h-12 w-full rounded-xl border border-gray-200 bg-gray-50 px-4 text-sm text-[#0d2461] outline-none transition-all placeholder:text-gray-400 focus:border-[#0d2461] focus:bg-white focus:ring-4 focus:ring-[#0d2461]/5"
                                            />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            name="product"
                                            defaultValue=""
                                            className="h-12 w-full appearance-none rounded-xl border border-gray-200 bg-gray-50 px-4 text-sm text-[#0d2461] outline-none transition-all focus:border-[#0d2461] focus:bg-white focus:ring-4 focus:ring-[#0d2461]/5"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-sm leading-6 text-[#0d2461] outline-none transition-all placeholder:text-gray-400 focus:border-[#0d2461] focus:bg-white focus:ring-4 focus:ring-[#0d2461]/5"
                                        />
                                    </div>
                                    ...
                                    <button
                                        type="submit"
                                        className="group flex h-13 w-full items-center justify-center gap-3 rounded-xl bg-[#0d2461] px-6 py-3.5 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#102d7a] hover:shadow-xl"
                                    >
                                        Send Inquiry
                        ...
                        <div className="flex flex-col justify-between bg-[#0d2461] p-7 sm:p-9">
                            ...
                            <div className="mt-10 border-t border-white/10 pt-6">
                                ...
                                <p className="text-xs leading-6 text-white/40">
                                    Looking to visit us or discuss your project in person?
                                    Get in touch with our team before your visit.
                                </p>
