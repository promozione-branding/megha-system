        ...
        <div className="max-w-[1850px] mx-auto flex flex-col lg:flex-row gap-6 lg:gap-10">
          ...
          <div className="w-full lg:w-2/3 flex-1 flex flex-col">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              {/* Left Column: Material Palette & Quote */}
              <div>
                <h3 className="text-2xl font-bold text-blue-950 mb-6">Material Palette</h3>
                <ul className="space-y-3.5 text-blue-900 mb-10">
              ...
              {/* Right Column: Key Features Accordion */}
              <div>
                <h3 className="text-2xl font-bold text-blue-950 mb-6">Key Features</h3>
                <div className="flex flex-col gap-3">
                    ...
                    >
                      ...
                      <div 
                        className={`px-5 overflow-hidden transition-all duration-300 ease-in-out ${
                          openAccordion === index ? 'max-h-40 pb-4 opacity-100' : 'max-h-0 opacity-0'
                        }`}
                      >
